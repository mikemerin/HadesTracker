...
export const aspectDescriptions: Mapping = {
  ...
  Aspect_of_Arthur: `You have ${Descriptions.Holy_Excalibur}, and +50 ${Descriptions.Max_Life} to your Life Total`,
  ...
  Aspect_of_Guan_Yu: `You have the ${Descriptions.Frost_Fair_Blade}, but your ${Descriptions.Max_Life} and ${Descriptions.Healing} are reduced`,
...
export const upgradeDescriptions: Mapping = {
  ...
  Charged_Flight: `Hold ${Descriptions.Special} for up to +200% base damage; minimum range reduced`,
  Charged_Shot: `Your ${Descriptions.Bull_Rush} instead fires a piercing shot that deals 80 base damage`,
  Charged_Skewer: `Hold ${Descriptions.Special} for up to +200% base damage; minimum range is reduced`,
  ...
  Cursed_Slash: `Your ${Descriptions.Attack} resores 2 ${Descriptions.Health}, but you have -60% ${Descriptions.Max_Life}`,
  Dash_Nova: `Your ${Descriptions.Special} makes you lunge ahead, then become ${Descriptions.Sturdy} for 1 Sec.`,
  Dashing_Flight: `During your ${Descriptions.Dash}, your ${Descriptions.Special} is faster and deals +200% damage`,
  Dashing_Wallop: `Your ${Descriptions.Dash_Strike} deals +50% damage in a larger area`,
  ...
  Exploding_Launcher: `Your ${Descriptions.Special} becomes a shot that deals 50 damage in an area`,
  Explosive_Fire: `Your ${Descriptions.Attack} deals damage in an area and briefly slows foes`,
  Explosive_Return: `Your ${Descriptions.Special} deals 50 damage to foes around you when you catch it`,
  ...
  Massive_Spin: `Your ${Descriptions.Spin_Attack} deals +125% damage and hits a larger area`,
  ...
  Piercing_Fire: `Your ${Descriptions.Attack} pierces foes and deals +50% damage to ${Descriptions.Armor}`,
  Piercing_Volley: `Your ${Descriptions.Special} pierces foes and deals +400% damage to ${Descriptions.Armor}`,
  Piercing_Wave: `Your ${Descriptions.Attack} fires a wave that pierces foes, dealing 30 damage`,
  Point_Blank_Shot: `Your ${Descriptions.Attack} deals +150% damage to foes around you`,
  ...
  Quick_Spin: `Your ${Descriptions.Spin_Attack} charges up and recovers much faster`,
  ...
  Rocket_Bomb: `Your ${Descriptions.Special} becomes a rocket that deals 80 base damage`,
  Rolling_Knuckle: `Your ${Descriptions.Dash_Strike} deals +60% damage; added to ${Descriptions.Attack} sequence`,
  Rush_Kick: `Your ${Descriptions.Special} becomes a flying kick that deals 40 base damage twice`,
  ...
  Shadow_Slash: `Your ${Descriptions.Attack} deals +200% damage striking foes from behind`,
  ...
  Sudden_Rush: `Your ${Descriptions.Bull_Rush} charges up faster`,
  ...
  World_Splitter: `Your ${Descriptions.Attack} becomes a big chop that deals 90 base damage`,
} as const;
